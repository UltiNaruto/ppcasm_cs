...
{
    class BEQ : PPC_Command
    {
        public BEQ(UInt32 curAddr, String[] args) : base(curAddr, args)
        {
            UInt32 val = 0x41820000;
            Int16 dist_jump = 0;
            UInt32 dest = 0;
            if (args.Length != 1)
                throw new Exception("beq <addr>");
        ...
        public override string Command => "beq";
    }
}
