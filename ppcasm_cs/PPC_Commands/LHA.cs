...
{
    class LHA : PPC_Command
    {
        public LHA(UInt32 curAddr, String[] args) : base(curAddr, args)
        {
            KeyValuePair<Int32, UInt32> idx_reg = default(KeyValuePair<Int32, UInt32>);
            UInt32 val = 0xa8000000;
            if (args.Length != 2)
                throw new Exception("lha <int_reg>, <idx_reg>");
        ...
        public override string Command => "lha";
    }
}