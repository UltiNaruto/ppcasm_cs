...
{
    class BSO : PPC_Command
    {
        public BSO(UInt32 curAddr, String[] args) : base(curAddr, args)
        {
            UInt32 val = 0x41830000;
            Int16 dist_jump = 0;
            UInt32 dest = 0;
            if (args.Length != 1)
                throw new Exception("bso <addr>");
        ...
        public override string Command => "bso";
    }
}
