...
{
    class BLE : PPC_Command
    {
        public BLE(UInt32 curAddr, String[] args) : base(curAddr, args)
        {
            UInt32 val = 0x40810000;
            Int16 dist_jump = 0;
            UInt32 dest = 0;
            if (args.Length != 1)
                throw new Exception("ble <addr>");
        ...
        public override string Command => "ble";
    }
}
