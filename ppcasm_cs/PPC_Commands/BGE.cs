...
{
    class BGE : PPC_Command
    {
        public BGE(UInt32 curAddr, String[] args) : base(curAddr, args)
        {
            UInt32 val = 0x40800000;
            Int16 dist_jump = 0;
            UInt32 dest = 0;
            if (args.Length != 1)
                throw new Exception("bge <addr>");
        ...
        public override string Command => "bge";
    }
}
