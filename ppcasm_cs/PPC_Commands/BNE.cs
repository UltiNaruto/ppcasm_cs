...
{
    class BNE : PPC_Command
    {
        public BNE(UInt32 curAddr, String[] args) : base(curAddr, args)
        {
            UInt32 val = 0x40820000;
            Int16 dist_jump = 0;
            UInt32 dest = 0;
            if (args.Length != 1)
                throw new Exception("bne <addr>");
        ...
        public override string Command => "bne";
    }
}
