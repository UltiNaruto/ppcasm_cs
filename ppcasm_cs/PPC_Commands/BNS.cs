...
{
    class BNS : PPC_Command
    {
        public BNS(UInt32 curAddr, String[] args) : base(curAddr, args)
        {
            UInt32 val = 0x40830000;
            Int16 dist_jump = 0;
            UInt32 dest = 0;
            if (args.Length != 1)
                throw new Exception("bns <addr>");
            ...
            dist_jump = (Int16)((long)dest - curAddr);
            ...
            val = (UInt32)(dist_jump + val);
            this.value = BitConverter.GetBytes(val).Reverse().ToArray();
        }

        public override string Command => "bns";
    }
}
